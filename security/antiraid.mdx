...
<Warning>
  ...
  This will temporarily disable intensive events which bender dispatches, such as
...
This module is a trigger user joined track avatar and kick, ban, user have default avatar discord.
