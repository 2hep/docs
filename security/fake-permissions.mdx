...
description: "Restrict moderators to only use bender for moderation."
icon: shield-check
---
...
When a moderator is given fake permissions, such as `ban_members`, they will be able to use the `ban` command with **bender**, but they won't be able to use the native **Discord** ban feature.
