---
title: "Server Antinuke"
description: "Protect your server discord for malicious user attack or destroy server"
icon: "fingerprint"
---

## Why use an antinuke system?

The anti-nuke system is important on your server to prevent moderators from abusing their privileges against other users or potentially destroying the entire server. It will keep it secure against any actions they might take.

## What is a function antinuke or how to work?
...
<Warning>
  It's **HIGHLY** recommended to utilize [fake
  permissions](/security/fake-permissions) to prevent moderators. Destroy server
</Warning>
...
<AccordionGroup>
  ...
  <Accordion title="Command Detection">
    Whether bender commands should be counted towards the threshold. (e.g. `,ban`)
...
<AccordionGroup>
  <Accordion title="Punishing members for changing the vanity URL">
    ...
    <Warning>
      bender can not change the vanity URL back to the original due to Discord limitations.
    </Warning>
    <CodeGroup>
